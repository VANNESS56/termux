...
figlet -f slant TERMUX THEME | lolcat
echo -e $lgreen "Welcome Lord Wim🗿"
echo -e $green "┏━━━━━━━━━━━━━━━━━━━━━━━━━┓"
echo -e $green "┃Author :"$red"VANNESS TZY"
echo -e $green "┃Script :"$red"TAMPILAN"
echo -e $green "┃WhatsApp :"$red"0882-8686-8638"
echo -e $green "┗━━━━━━━━━━━━━━━━━━━━━━━━━┛"
echo
trap ctrl_c INT
ctrl_c() {
...
echo "echo" >> bash.bashrc
echo "echo -e '\e[0;36m' 'VANNESS TEAMS'" >> bash.bashrc
...
echo "echo -e '${lightgreen}informasi kernel: \t${red}' `uname -smr`" >> bash.bashrc
echo "echo" >> bash.bashrc
echo "echo -e '\e[0;36m' 'V A N N E S S . T Z Y'" >> bash.bashrc
echo "echo -e '\e[0;36m' ''SELAMAT DATANG TUANKU ADA YANG BISA SAYA BANTU''" >> bash.bashrc
echo "echo" >> bash.bashrc
echo "echo -e '\e[0;35m' '<|-----------------------------------------------------------------|>'" >> bash.bashrc
echo "echo" >> bash.bashrc
...
;;
00) echo -e $purple " [*] Created By : VANNESS TZY"
sleep 1
